...
const meta=(title,description)=>'<meta name="description" content="'+escape(description)+'"><meta property="og:title" content="'+escape(title)+'"><meta property="og:description" content="'+escape(description)+'"><meta property="og:type" content="website"><link rel="stylesheet" href="/site.css"><link rel="icon" href="/favicon.svg" type="image/svg+xml">';
const shell=(title,description,body)=>'<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'+escape(title)+' | Paper Switch</title><link rel="stylesheet" href="/assets/style.css">'+meta(title,description)+'</head><body>'+header+'<main><h1>'+escape(title)+'</h1><p class="intro">'+escape(description)+'</p>'+body+'</main>'+footer+'<script type="module" src="/site.js"></script></body></html>';
...
const pages={
 ...
 privacy:['Privacy','How files and preferences are handled.','<h2>Files and preferences</h2><p>Selected files and QR contents are not uploaded to a conversion server. Your language preference is saved in this browser and can be removed by clearing site data.</p><h2>Hosting and advertising</h2><p>Cloudflare serves this website and receives normal web requests, including network and browser information. This version includes no advertising or analytics scripts.</p><p>For privacy questions, use the contact page. Emails are handled separately by the email provider.</p><a href="/contact">Contact</a>']
};
...
await writeFile(out+'/404.html',shell('Page not found','Choose a tool from the home page.','<a href="/">All tools</a>'));
