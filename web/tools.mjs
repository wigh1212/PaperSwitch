...
export const formats=['pdf','heic','png','svg','jpg','webp','tiff','txt'];
...
export const tools=[{slug:"gif-maker",type:"gif",title:gifRows[3][0],description:gifRows[1][0],note:gifRows[2][0]},...growthTools,{slug:"image-compressor",type:"compressor",title:compressorRows[0][0],description:compressorRows[1][0],note:compressorRows[2][0]},...unique.values(),{slug:'merge-pdf',mode:'pdf-merge',input:'pdf',output:'pdf',type:'convert',title:'Merge PDF',description:'Combine PDF documents in your chosen order.',note:'All pages are merged. Bookmarks and digital signatures are not preserved.'},
