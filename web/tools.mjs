...
export const formats=['pdf','png','svg','jpg','webp','tiff','txt'];
...
export const tools=[...unique.values(),{slug:'merge-pdf',mode:'pdf-merge',input:'pdf',output:'pdf',type:'convert',title:'Merge PDF',description:'Combine PDF documents in your chosen order.',note:'All pages are merged. Bookmarks and digital signatures are not preserved.'},
